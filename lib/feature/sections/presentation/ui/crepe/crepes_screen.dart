...
import 'package:slice_app/feature/sections/presentation/ui/crepe/widget/back_ground_body_crepe.dart';
...
class CrepesScreen extends StatelessWidget {
      CrepesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "crepe", backgroundColor:Colors.amber),

      body: BackGroundBodyCrepe(gradientBackGround: AppColor.primary),
