...
class AppetizersScreen extends StatelessWidget {
  const AppetizersScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: "Garnish",
        backgroundColor: const Color.fromARGB(255, 255, 169, 119),
      ),
      body:Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            Color.fromARGB(255, 255, 169, 119).withValues(alpha: 1),
            AppColor.lightgray,
          ],
        ...
        width: double.infinity,
        child: FutureBuilder(
          future: FirebaseService.getAppetizers(),
      ...
      floatingActionButton: IconButton(
        onPressed: () {
          ...
          ).then((value) => print('Appetizers Added'));
        },
        style: ButtonStyle(
